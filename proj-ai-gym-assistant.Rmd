...
The Random Forest algorighm shows better results with the accuracy of `r round(res[1,2]*100, 1)`% and the expected out-of-sample accuracy between `r round(res[1,1]*100, 1)`% and `r round(res[1,3]*100, 1)`% (95% confidence level). Let's check the actual out-of-sample errors against the validation partition.
